...
2.  **Manejo de Desbalance:** La clase positiva (fuga) representaba solo el 20% de los datos. Se utilizaron técnicas de **Upsampling** para equilibrar el entrenamiento.
...
* **Rendimiento:** Se superó el umbral de F1-Score requerido (> 0.59) y se obtuvo un AUC-ROC competitivo, permitiendo una segmentación efectiva de clientes.
